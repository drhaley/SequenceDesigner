...
from arbiter.decorators.not_sticky_to_pairs_lite import NotStickyToPairsLiteDecorator
...
class TestNotStickyToPairsLiteDecorator(unittest.TestCase):
    def setUp(self):
        ...
        self.arbiter = NotStickyToPairsLiteDecorator(base_arbiter, self.threshold)
